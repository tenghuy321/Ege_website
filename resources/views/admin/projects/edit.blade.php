<x-app-layout>
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <div class="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between">
            <h2 class="text-2xl font-bold">Edit Our Projects</h2>
        ...
        <form action="{{ route('project.update', $project->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input value="{{ old('project_name', $project->project_name) }}" type="text" name="project_name"
                    id="project_name"
                    class="text-green-900 text-sm mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500">
            ...
            <div>
                ...
                <input value="{{ old('scope_of_work', $project->scope_of_work) }}" type="text" name="scope_of_work"
                    id="scope_of_work"
                    class="text-green-900 text-sm mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500">
            ...
            <div>
                ...
                <input value="{{ old('location', $project->location) }}" type="text" name="location" id="location"
                    class="text-green-900 text-sm mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500">
                <x-input-error class="mt-2" :messages="$errors->get('location')" />
            </div>
            <div>
                <label for="year" class="block text-sm font-medium text-gray-700">Year</label>
                <input value="{{ old('year', $project->year) }}" type="text" name="year" id="year"
                    class="text-green-900 text-sm mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500">
            ...
            <div>
                ...
                <textarea name="overview" id="overview" rows="4"
                    class="text-green-900 text-sm mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500">{{ old('overview', $project->overview) }}</textarea>
            ...
            <div>
                ...
                <textarea name="challenges" id="challenges" rows="4"
                    class="text-green-900 text-sm mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500">{{ old('challenges', $project->challenges) }}</textarea>
            ...
            <div>
                ...
                <textarea name="solution" id="solution" rows="4"
                    class="text-green-900 text-sm mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500">{{ old('solution', $project->solution) }}</textarea>
                        ...
                        <div class="flex flex-col mb-4 impact-item">
                            ...
                            <div class="mb-2">
                                <input type="text" name="impact[{{ $index }}][title]"
                                    ...
                                    placeholder="Impact Title"  value="{{ old('impact.' . $index . '.title', $item->title ?? '') }}">
                            ...
                            <div class="mb-2">
                                <textarea name="impact[{{ $index }}][body]"
                                    ...
                                    placeholder="Impact Body">{{ old('impact.' . $index . '.body', $item->body ?? '') }}</textarea>
                                <p class="mt-2 text-sm text-green-600 dark:text-green-500">
            ...
            <div>
                ...
                <textarea name="conclusion" id="conclusion" rows="4"
                    class="text-green-900 text-sm mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500   ">{{ old('conclusion', $project->conclusion) }}</textarea>
            ...
            <div>
                ...
                <textarea name="testimonial" id="testimonial" rows="4"
                    class="text-green-900 text-sm mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500   ">{{ old('testimonial', $project->testimonial) }}</textarea>
            ...
            <div class="">
                <label for="dropzone-file{{ $project->id }}" id="drop-area"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-cover bg-no-repeat rounded-md text-center"
                        id="img-preview" style="background-image: url({{ asset($project->image) }})">
                    ...
                    <input id="dropzone-file{{ $project->id }}" type="file" class="hidden" name="image"
