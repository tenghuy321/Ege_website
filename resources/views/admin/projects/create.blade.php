<x-app-layout>
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <div class="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between">
            <h2 class="text-2xl font-bold">Create Our Projects</h2>
            <a href="{{ route('project.index') }}" class="!bg-[#A4CA62] hover:!text-[#415464] px-3 py-1 hover:tracking-wider duration-300 my-3 rounded-md text-[12px] sm:text-[14px] text-[#ffffff]">
        ...
        <form action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input value="{{ old('project_name') }}"
                    type="text" name="project_name" id="project_name" class="mt-1 block w-full p-2 border rounded-md focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <input value="{{ old('scope_of_work') }}"
                    type="text" name="scope_of_work" id="scope_of_work" class="mt-1 block w-full p-2 border rounded-md focus:ring-blue-500 focus:border-blue-500">
                <x-input-error class="mt-2" :messages="$errors->get('scope_of_work')" />
            </div>
            <div>
                <label for="location" class="block text-sm font-medium text-gray-700">Location</label>
                <input value="{{ old('location') }}"
                    type="text" name="location" id="location" class="mt-1 block w-full p-2 border rounded-md focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <textarea
                    name="overview" id="overview" rows="4" class="mt-1 block w-full p-2 border rounded-md focus:ring-blue-500 focus:border-blue-500">{{ old('overview') }}</textarea>
            ...
            <div>
                ...
                <textarea
                    name="challenges" id="challenges" rows="4" class="mt-1 block w-full p-2 border rounded-md focus:ring-blue-500 focus:border-blue-500">{{ old('challenges') }}</textarea>
            ...
            <div>
                ...
                <textarea
                    name="solution" id="solution" rows="4" class="mt-1 block w-full p-2 border rounded-md focus:ring-blue-500 focus:border-blue-500">{{ old('solution') }}</textarea>
            ...
            <div>
                ...
                <textarea
                    name="conclusion" id="conclusion" rows="4" class="mt-1 block w-full p-2 border rounded-md focus:ring-blue-500 focus:border-blue-500">{{ old('conclusion') }}</textarea>
            ...
            <div>
                ...
                <textarea
                    name="testimonial" id="testimonial" rows="4" class="mt-1 block w-full p-2 border rounded-md focus:ring-blue-500 focus:border-blue-500">{{ old('testimonial') }}</textarea>
