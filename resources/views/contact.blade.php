...
@section('content')
    ...
    <div class="bg-[#D9ECEE] pt-10 pb-10 md:pb-20">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-12 gap-4 py-10">
                <div class="col-span-7 sm:col-span-8 lg:col-span-4 text-[12px] sm:text-[14px]">
                ...
                <div class="col-span-5 sm:col-span-4 lg:col-span-3">
                    ...
                    <ul class='text-[14px] text-[#415464] flex flex-col space-y-1'>
                        ...
                        <li>
                            <a href="{{ route('about') }}"
                                class="{{ Route::is('about') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">About
                                Us</a>
                        </li>
                        <li>
                            <a href="{{ route('products') }}"
                                class="{{ Route::is('products') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Products</a>
                        </li>
                        <li>
                            <a href="{{ route('services') }}"
                                class="{{ Route::is('services') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Services</a>
                        </li>
                        <li>
                            <a href="{{ route('careers') }}"
                                class="{{ Route::is('careers') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Careers</a>
                        </li>
                        <li class="relative">
                            <a href="{{ route('events') }}"
                        ...
                        <li>
                            <a href="{{ route('projects') }}"
                                class="{{ Route::is('projects') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Projects</a>
                        </li>
                        <li>
                            <a href="{{ route('contact') }}"
                                class="{{ Route::is('contact') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Contact
                                Us</a>
                        </li>
                    </ul>

                    <h1 class='text-[#A4CA62] text-[18px] font-[700] pt-10'>Follow Us</h1>
                    <div class='flex space-x-2 pt-2'>
                        <a href="https://www.facebook.com/share/1By1qNP5MY/?mibextid=wwXIfr"
                        ...
                        <a href="https://www.linkedin.com/company/ege-cambodia-energy-solutions-co-ltd/"
                            class='transition-all hover:scale-110 duration-200'>
                            <svg width="28" height="28" viewBox="0 0 30 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class='col-span-12 lg:col-span-5'>
                    ...
                    <div class='flex flex-col space-y-4 text-[14px] text-[#415464]'>
                        <div class='flex items-start space-x-1'>
                            <div>
                                <svg class="w-6 h-6 text-[#415464]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                        strokeWidth="1.5" d="M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                        strokeWidth="1.5"
                                        d="M17.8 13.938h-.011a7 7 0 1 0-11.464.144h-.016l.14.171c.1.127.2.251.3.371L12 21l5.13-6.248c.194-.209.374-.429.54-.659l.13-.155Z" />
                                </svg>
                            </div>
                            <p class='p-[2px]'>Borey Chip Mong 271, #117, St Commercial, Sangkat Chak Agre Leu,Khan Mean
                                Chey, Phnom Penh, Cambodia</p>
                        </div>
                        <div class='flex items-start space-x-1'>
                            <div>
                                <svg class="w-6 h-6 text-[#415464]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="map-container mt-4">
                        <iframe class="w-full h-[200px] sm:h-[300px] rounded-lg"
    ...
    <div class='bg-[#415464] text-[#A4CA62] text-center py-2 text-[15px]'>
