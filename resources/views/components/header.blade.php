<section class="w-full bg-[#D9ECEE] hidden lg:block">
    <div class="max-w-7xl mx-auto px-7 flex space-x-4 items-end justify-end pt-2 pb-1">
        <div class="text-[12px] flex items-center space-x-2">
        ...
        <div class="text-[12px] flex items-center space-x-2">
            ...
            <p>078 256 088 / 012 256 068</p>
        </div>
    </div>
</section>

<section class="px-[1rem] w-full h-[74px] items-center gap-[1rem] flex justify-between bg-[#D9ECEE] z-10 lg:hidden">
    <img src="{{ asset('assets/images/logo.png') }}" alt="" class="w-20">

    <div class="">
        <button class="text-white mb-2 focus:outline-none " type="button" data-drawer-target="drawer-example"
            ...
            <svg width="20" height="20" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M60.9741 138.583H96.3593C119.641 138.583 138.583 119.641 138.583 96.3593V60.9741C138.583 37.6923 119.641 18.75 96.3593 18.75H60.9741C37.6923 18.75 18.75 37.6923 18.75 60.9741V96.3593C18.75 119.641 37.6923 138.583 60.9741 138.583ZM37.5 60.9741C37.5 48.0286 48.0286 37.5 60.9741 37.5H96.3593C109.305 37.5 119.833 48.0286 119.833 60.9741V96.3593C119.833 109.305 109.305 119.833 96.3593 119.833H60.9741C48.0286 119.833 37.5 109.305 37.5 96.3593V60.9741Z"
                    fill="#A3C962" />
                <path
                    d="M239.026 18.75H203.641C180.359 18.75 161.417 37.6923 161.417 60.9741V96.3593C161.417 119.641 180.359 138.583 203.641 138.583H239.026C262.308 138.583 281.25 119.641 281.25 96.3593V60.9741C281.25 37.6923 262.308 18.75 239.026 18.75ZM262.5 96.3593C262.5 109.305 251.972 119.833 239.026 119.833H203.641C190.696 119.833 180.167 109.305 180.167 96.3593V60.9741C180.167 48.0286 190.696 37.5 203.641 37.5H239.026C251.972 37.5 262.5 48.0286 262.5 60.9741V96.3593Z"
                    fill="#A3C962" />
                <path
                    d="M60.9741 281.25H96.3593C119.641 281.25 138.583 262.308 138.583 239.026V203.641C138.583 180.359 119.641 161.417 96.3593 161.417H60.9741C37.6923 161.417 18.75 180.359 18.75 203.641V239.026C18.75 262.308 37.6923 281.25 60.9741 281.25ZM37.5 203.641C37.5 190.696 48.0286 180.167 60.9741 180.167H96.3593C109.305 180.167 119.833 190.696 119.833 203.641V239.026C119.833 251.972 109.305 262.5 96.3593 262.5H60.9741C48.0286 262.5 37.5 251.972 37.5 239.026V203.641Z"
                    fill="#A3C962" />
                <path
                    d="M221.338 161.417C188.297 161.417 161.417 188.297 161.417 221.338C161.417 254.37 188.297 281.25 221.338 281.25C254.37 281.25 281.25 254.37 281.25 221.338C281.25 188.297 254.37 161.417 221.338 161.417ZM221.338 262.5C198.633 262.5 180.167 244.034 180.167 221.338C180.167 198.633 198.633 180.167 221.338 180.167C244.034 180.167 262.5 198.633 262.5 221.338C262.5 244.034 244.034 262.5 221.338 262.5Z"
                    fill="#A3C962" />
            </svg>
        </button>
    </div>
    ...
    <div id="drawer-example"
        class="fixed top-0 left-0 z-40 h-screen overflow-y-auto transition-transform -translate-x-full duration-500 ease-in-out bg-white w-80"
        tabindex="-1" aria-labelledby="drawer-label">
        <div class="flex justify-between items-center p-4">
            <img src="{{ asset('assets/images/logo.png') }}" alt="" class="w-20">
            <button type="button" data-drawer-hide="drawer-example" aria-controls="drawer-example"
                class="text-[#A3C962] focus:outline-none">
        ...
        <hr class="h-1 bg-[#A3C962]" />


        <div class="relative">
            <ul class="flex flex-col items-start justify-start space-y-5 pt-6 p-5">
                <li class="relative block">
                    <a href="{{ route('home') }}"
                        class="{{ Route::is('home') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Home</a>
                </li>
                <li class="w-full relative block" x-data="{ open: false }">
                    <div class="flex items-center justify-between">
                        <a href="{{ route('about') }}"
                            class="block w-full {{ Route::is('about') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">About
                            Us</a>
                        <button @click="open = !open" :class="{ 'rotate-45': open }" class="transition-transform">
                            <i class="fa-solid fa-plus text-[12px]"></i>
                        </button>
                    </div>

                    <div x-show="open" x-transition class="opacity-100">
                        <ul class="pt-4">
                            <li><a href="/about#vision" class="block px-2 text-[14px] text-[#415464]">Vision</a></li>
                            <li><a href="/about#mission" class="block px-2 text-[14px] text-[#415464]">Mission</a></li>
                            <li><a href="/about#core_values" class="block px-2 text-[14px] text-[#415464]">Core Values</a>
                            </li>
                            <li><a href="/about#history" class="block px-2 text-[14px] text-[#415464]">Our History</a></li>
                            <li><a href="/about#management_team" class="block px-2 text-[14px] text-[#415464]">Management
                                    Team</a></li>
                            <li><a href="/about#registration_docs"
                                    class="block px-2 text-[14px] text-[#415464]">Registration Docs</a></li>
                            <li><a href="/about#certificate" class="block px-2 text-[14px] text-[#415464]">Certificate of
                                    Auth</a></li>
                        </ul>
                    </div>
                </li>
                <li class="w-full relative block" x-data="{ open: false }">
                    <div class="flex items-center justify-between">
                        <a href="{{ route('products') }}"
                            class="block w-full {{ Route::is('products') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Products</a>
                        <button @click="open = !open" :class="{ 'rotate-45': open }" class="transition-transform">
                            <i class="fa-solid fa-plus text-[12px]"></i>
                        </button>
                    </div>
                    <div x-show="open" x-transition class="opacity-100">
                        <ul class="pt-4">
                            <li><a href="/products#product" class="block px-2 text-[14px] text-[#415464]">Products</a>
                            </li>
                            <li><a href="/products#reason" class="block px-2 text-[14px] text-[#415464]">6 Reason to
                                    choose us</a></li>
                        </ul>
                    </div>
                </li>
                <li class="relative block w-full" x-data="{ open: false }">
                    <div class="flex items-center justify-between">
                        <a href="{{ route('services') }}"
                            class="block w-full {{ Route::is('services') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Services</a>
                        <button @click="open = !open" :class="{ 'rotate-45': open }" class="transition-transform">
                            <i class="fa-solid fa-plus text-[12px]"></i>
                        </button>
                    </div>
                    <div x-show="open" x-transition class="opacity-100">
                        <ul class="pt-4">
                            <li><a href="/services#feasibility" class="block px-2 text-[14px] text-[#415464]">Feasibility
                                    Studies & Site Survey</a></li>
                            <li><a href="/services#project_management"
                ...
                <li class="relative block w-full" x-data="{ open: false }">
                    <div class="flex items-center justify-between">
                        <a href="{{ route('careers') }}"
                            class="block w-full {{ Route::is('careers') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Careers</a>
                        <button @click="open = !open" :class="{ 'rotate-45': open }" class="transition-transform">
                            <i class="fa-solid fa-plus text-[12px]"></i>
                        </button>
                    </div>
                    <div x-show="open" x-transition class="opacity-100">
                        <ul class="pt-4">
                            <li><a href="/careers#career" class="block px-2 text-[14px] text-[#415464]">Careers</a></li>
                        </ul>
                    </div>
                </li>
                <li class="relative block">
                    <a href="{{ route('events') }}"
                        class="{{ Route::is('events') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Events</a>
                </li>
                <li class="relative block w-full" x-data="{ open: false }">
                    <div class="flex items-center justify-between">
                        <a href="{{ route('projects') }}"
                            class="block w-full {{ Route::is('projects') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Projects</a>
                        <button @click="open = !open" :class="{ 'rotate-45': open }" class="transition-transform">
                            <i class="fa-solid fa-plus text-[12px]"></i>
                        </button>
                    </div>
                    <div x-show="open" x-transition class="opacity-100">
                        <ul class="pt-4">
                            <li><a href="/projects#project" class="block px-2 text-[14px] text-[#2E4354]">Project
                                Credentials</a></li>
                            <li><a href="/projects#activities"
                                    class="block px-2 text-[14px] text-[#2E4354]">Activities</a></li>
                        </ul>
                    </div>
                </li>
                <li>
                    <a href="{{ route('contact') }}"
                        class="{{ Route::is('contact') ? 'text-[#415464] font-bold' : 'text-[#415464]' }}">Contact Us</a>
                </li>
            </ul>
